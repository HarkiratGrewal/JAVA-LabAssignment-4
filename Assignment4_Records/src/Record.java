				...
				if(option == 0) {	//	Books Table
					...
					while(bool == true) {
						...
						if(function == 7) {
							...
							try {
								System.out.println("Enter the ddate in format (YYYY-MM-DD) to display the total sales amount:");
								Scanner date = new Scanner(System.in);
								String dateSales = date.nextLine();
								java.util.Date date2 = null;
									try {
										date2 = new SimpleDateFormat("yyyy-MM-dd").parse(dateSales);
									}
									catch(Exception e) {
										System.out.println("Check again");
									}
								String query="SELECT QUANTITY * PRICE FROM SALES WHERE SALESDATE = '" + new java.sql.Date(date2.getTime()) + "';";
...
//			input.close();
	...
	public String DisplayMenu() {
		return "******************************\r\n" + "1. Add Record\r\n" + "2. View Record\r\n" + "3. Update record\r\n" + "4. Delete Record\r\n" + "5. Search\r\n" + "6. Total amount for given Sales Date, Gets from Sales Table only:\r\n" + "6. Quit\r\n" + "******************************\r\n";
	}	//	DisplayMenu
